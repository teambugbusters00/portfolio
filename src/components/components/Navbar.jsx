  ...
  return (
    ...
    >
      <div className="flex items-center justify-between max-w-8xl my-2 mx-4 relative">
        <a href="#hero" className="flex mx-6 items-center justify-center gap-4">
          <img src="/vijay.jpg" alt="Vijay" className="h-16 w-16 object-cover rounded-full" />
          <h1 style={{ fontSize: "35px", fontWeight: "500" }}>VIJAY RAMDEV</h1>
        </a>
        <button
